...
export const redlineMetroStation = {
    ...
    "捷運_民權西路"     : { name : "民權西路"       , latitude : 25.062905     , longtitude : 121.519319    , title : "民權西路站(Minquan W. Road Station) | 台北市大同區"                      },
    "捷運_圓山"         : { name : "圓山"           , latitude : 25.071353     , longtitude : 121.520118    , title : "圓山站(Yuanshan Station) | 台北市大同區"                                 },
    "捷運_劍潭"         : { name : "劍潭"           , latitude : 25.084873     , longtitude : 121.525077    , title : "劍潭站(Jiantan Station) | 台北市士林區"                                  },
    "捷運_士林"         : { name : "士林"           , latitude : 25.093535     , longtitude : 121.526229    , title : "士林站(Shilin Station) | 台北市士林區"                                   },
    "捷運_芝山"         : { name : "芝山"           , latitude : 25.103059     , longtitude : 121.522513    , title : "芝山站(Zhishan Station) | 台北市士林區"                                  },
    "捷運_明德"         : { name : "明德"           , latitude : 25.10972      , longtitude : 121.518848    , title : "明德站(Mingde Station) | 台北市北投區"                                   },
    "捷運_石牌"         : { name : "石牌"           , latitude : 25.114523     , longtitude : 121.515559    , title : "石牌站(Shipai Station) | 台北市北投區"                                   },
    "捷運_唭哩岸"       : { name : "唭哩岸"         , latitude : 25.120871     , longtitude : 121.506252    , title : "唭哩岸站(Qilian Station) | 台北市北投區"                                 },
    "捷運_奇岩"         : { name : "奇岩"           , latitude : 25.125491     , longtitude : 121.501132    , title : "奇岩站(Qiyan Station) | 台北市北投區"                                    },
    "捷運_北投"         : { name : "北投"           , latitude : 25.13184      , longtitude : 121.498632    , title : "北投站(Beitou Station) | 台北市北投區"                                   },
    "捷運_復興崗"       : { name : "復興崗"         , latitude : 25.137473     , longtitude : 121.485444    , title : "復興崗站(Fuxinggang Station) | 台北市北投區"                             },
    "捷運_忠義"         : { name : "忠義"           , latitude : 25.130969     , longtitude : 121.473409    , title : "忠義站(Zhongyi Station) | 台北市北投區"                                  },
    "捷運_關渡"         : { name : "關渡"           , latitude : 25.125632     , longtitude : 121.467102    , title : "關渡站(Guandu Station) | 台北市北投區"                                   },
    "捷運_竹圍"         : { name : "竹圍"           , latitude : 25.13694      , longtitude : 121.459479    , title : "竹圍站(Zhuwei Station) | 新北市淡水區"                                   },
